...
Важно: [Примеры из лекций](https://github.com/netology-code/kt-code) можно использовать для самостоятельной отработки материалов лекции, а также для выполнения домашнего задания.
