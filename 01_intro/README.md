...
* настроен Kotlin;
* присутствует файл .gitignore, взятый из репозитория курса;
...
При создании проекта используйте следующие настройки. Версию JDK можно ставить любую, выше 11. Рекомендуется использовать Axiom JDK.
